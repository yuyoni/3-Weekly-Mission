...
import facebook from "../../../public/assets/modal/Facebook.svg";
import kakao from "../../../public/assets/modal/Kakao.svg";
import link from "../../../public/assets/modal/link.svg";
import shareKakao from "../../_utils/shareKakaoLink";
...
export default function IconBox({ userId, folderId, folderName }) {
  ...
  return (
    <Container>
      ...
      >
        <Image src={kakao} alt="kakao-icon" />
      </IconWrapper>
